  ...
  return (
    <section className="premium-card relative overflow-hidden rounded-[2rem] p-5 text-center sm:p-8">
      <div className="mb-5 flex items-start justify-between">
        ...
        <button onClick={onWish} className="grid h-12 w-12 place-items-center rounded-2xl border border-primary/40 bg-card/70 text-foreground shadow-sm">
      ...
      <div className="mx-auto my-6 flex max-w-3xl items-center justify-center gap-4 text-primary">
        ...
        <span className="h-px flex-1 bg-gradient-to-l from-transparent via-primary to-primary/20" />
      </div>
  ...
  return (
    <section className="premium-card relative overflow-hidden rounded-[1.5rem] p-4 text-center sm:p-5">
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="grid h-10 w-10 place-items-center rounded-xl border border-primary/40 bg-card/70 text-foreground"><Heart className="h-5 w-5" /></span>
      </div>
      <div className="flex items-center justify-center gap-2 text-sm font-bold text-foreground"><Crown className="h-4 w-4 text-primary" /> Signature Family Pack</div>
      <h2 className="mt-1 text-2xl font-black text-foreground sm:text-3xl">{title}</h2>
      <p className="mb-3 text-sm font-semibold text-primary">Perfect Matching Set</p>
      ...
      <div className="mx-auto mt-3 grid max-w-2xl grid-cols-3 gap-2">
        <div className="rounded-xl border border-primary/20 bg-card/60 p-2"><div className="text-[10px] text-muted-foreground">Qty</div><b className="text-sm text-foreground">{numbers.length} Numbers</b></div>
        <div className="rounded-xl border border-primary/20 bg-card/60 p-2"><div className="text-[10px] text-muted-foreground">Value</div><b className="text-sm text-foreground">Premium</b></div>
        <div className="rounded-xl border border-primary/20 bg-card/60 p-2"><div className="text-[10px] text-muted-foreground">Per No.</div><b className="text-sm text-foreground">{formatINR(perNumber)}</b></div>
      </div>
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        ...
        <button className="rounded-xl border border-foreground bg-card/65 px-4 py-2.5 text-sm font-black text-foreground"><ShoppingCart className="mr-1.5 inline h-5 w-5" />Add to Cart</button>
      </div>
    </section>
  );
}
